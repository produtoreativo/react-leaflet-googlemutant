...
var GoogleMutant = function (_MapLayer) {
  ...
  function GoogleMutant() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = GoogleMutant.__proto__ || Object.getPrototypeOf(GoogleMutant)).call.apply(_ref, [this].concat(args))), _this), _this.version = "0.1.20", _temp), _possibleConstructorReturn(_this, _ret);
  }
